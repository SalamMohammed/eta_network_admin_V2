...
class _ReferralsRanksPageState extends State<ReferralsRanksPage> {
  ...
  Future<void> _loadData() async {
    await Future.wait([_loadTopReferrers(), _loadGlobalMetrics()]);
  }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Updated $count users')));
        // Reload table
        _loadTopReferrers();
      }
    } catch (e) {
        ...
        children: [
          Wrap(
            ...
            children: [
              _metric(
                'Total Users',
                _totalUsers > 0 ? '$_totalUsers' : 'Loading...',
              ),
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Text(
                      'Top Referrers (Realtime Active Count)',
                      style: TextStyle(
                        fontSize: 18,
