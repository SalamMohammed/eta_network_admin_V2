...
class _OnboardingFlowState extends State<OnboardingFlow> {
      ...
      Column(
        children: const [
          ...
          _Bullet(
            ...
            text: 'Use it in future marketplace',
          ),
        ],
      ),
    );
    ...
    return _page(
      Column(
        children: const [
          ...
          SizedBox(height: 16),
          Text(
            'Your early ETA points will define your power in the future ecosystem.',
          ),
        ],
      ),
    );
  ...
  Widget _permissions() {
    final auth = _notifSettings?.authorizationStatus;
    final authorized =
    ...
    return _page(
      Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'Get reminders when your mining session ends and important updates about your account.',
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(
                  authorized ? Icons.check_circle : Icons.notifications_active,
                  color: authorized
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                onPressed: _requestingNotifPermission
                    ? null
                    : () async {
                        ...
                        try {
                          ...
                          if (mounted) {
                            setState(() => _requestingNotifPermission = false);
                          }
                        }
                      },
                child: Text(authorized ? 'Re-check' : 'Enable Notifications'),
              ),
              const SizedBox(width: 12),
              TextButton(
                onPressed: () => _ctrl.nextPage(
      ...
      Column(
        children: [
          Container(
            ...
            child: const Text(
              'These are loyalty points, not crypto yet.\nNo guaranteed future value.',
            ),
          ),
          const SizedBox(height: 12),
          Row(
            ...
            onPressed: understood
                ? () async {
                    ...
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const MobileAppScaffold(),
                      ),
                    );
                  }
                : null,
...
class _Arc extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return SizedBox(height: 160, child: CustomPaint(painter: _ArcPainter()));
  }
}
